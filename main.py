...
/slills - используй что бы выбрать проект, для которого хочешь выбрать навык
/project - это список твоих команд
/delete - используй для удаления проекта
/update_projects - используй для обнавления проекта
...
def addtask_command(message):
    bot.send_message(message.chat.id, "⌨️Введите название проекта:")
...
def update_project_step_4(message, project_name, attribute): 
    ...
    bot.send_message(message.chat.id, "Готово! Обновления внесены☑️!)")
